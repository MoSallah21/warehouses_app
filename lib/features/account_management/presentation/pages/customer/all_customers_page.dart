...
import 'package:eks/features/account_management/presentation/pages/customer/detail_customer_page.dart';
import 'package:eks/features/account_management/presentation/pages/customer/update_customer_page.dart';
...
class _AllCustomersPageState extends State<AllCustomersPage> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      )..getAllUsers(AccountType.customer),
      child: Scaffold(
        ...
        body: BlocBuilder<AccountCubit, AccountState>(
          builder: (context, state) {
            ...
            if(state is DeleteAccountSuccessState){
              ...
              cubit.getAllUsers(AccountType.customer);
            }
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(S.of(context).allCustomers, style: const TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Column(
                            children: [
                              InkWell(
                                onTap:(){
                                  navigateTo(context, DetailCustomerPage(
                                    ...
                                    children: [
                                      Expanded(
                                        child: Padding(
                                          ...
                                          child: Column(
                                            children: [
                                              Text(user.username!,style:TextStyle(fontSize: screenWidth * 0.033,
                                              ) ,),
                                            ],
                                          ),
                                        ),
                              ...
                              Row(
                                ...
                                children: [
                                  IconButton(
                                    ...
                                    onPressed: () {
                                      navigateTo(context, UpdateCustomerPage(
                                        id: user.id!,
                                        oldUsername: user.username!,
                                        oldAddress: user.address!,
                                        oldPhone: user.phone!,
                                    ...
                                    onPressed: () {
                                      showDialog(
                                        ...
                                        builder: (BuildContext context) {
                                          return AlertMessage().alertDia(S.of(context).customer,context,
                                                  (){
                                                cubit.deleteAccount(user.id!,AccountType.customer);
                                                return null;
