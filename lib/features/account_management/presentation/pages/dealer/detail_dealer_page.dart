...
class DetailDealerPage extends StatelessWidget {
  final int id;
  ...
  DetailDealerPage({super.key,required this.id, required this.oldUsername, required this.oldAddress, required this.oldPhone, required this.oldAdministratorName, required this.oldAdministratorPhone});
